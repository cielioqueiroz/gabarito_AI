...
/* O azul-caneta da marca (#4A72E8) só rende 4.32:1 com texto branco — abaixo do
   mínimo AA. Sólidos com texto branco usam #4064D8 (5.21:1) e reservam #4A72E8
   para o hover; azul como *texto* usa #A8BCF8 (10.1:1 no tema escuro). */
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A72E8] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:     'bg-[#4064D8] text-[#FFFFFF] font-bold hover:bg-[#4A72E8] shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_2px_10px_-2px_rgba(0,0,0,0.5)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_4px_16px_-2px_rgba(74,114,232,0.35)]',
        ...
        link:        'text-[#A8BCF8] underline-offset-4 hover:underline hover:text-foreground',
        amber:       'bg-[#4064D8] text-[#FFFFFF] font-bold hover:bg-[#4A72E8] shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_2px_10px_-2px_rgba(0,0,0,0.5)]',
      },
      size: {
