...
const cards = (
  <svg viewBox="0 0 200 160" className="w-full h-auto max-w-[220px] mx-auto">
    <g transform="rotate(-6 100 90)">
      <rect x="30" y="30" width="140" height="90" rx="4" fill="var(--c-surface)" stroke="var(--c-brand)" strokeOpacity="0.3"/>
    </g>
    <g transform="rotate(3 100 90)">
      <rect x="35" y="35" width="130" height="80" rx="4" fill="var(--c-elevated)" stroke="var(--c-brand)" strokeOpacity="0.5"/>
      <rect x="55" y="60" width="90" height="4" rx="2" fill="var(--c-brand)" opacity="0.7"/>
      <rect x="55" y="72" width="60" height="3" rx="2" fill="var(--c-muted)" opacity="0.5"/>
      <rect x="55" y="82" width="70" height="3" rx="2" fill="var(--c-muted)" opacity="0.5"/>
    </g>
  </svg>
)
...
const chart = (
  <svg viewBox="0 0 200 160" className="w-full h-auto max-w-[220px] mx-auto">
    ...
    <rect x="50"  y="80" width="18" height="50" rx="3" fill="var(--c-brand)" opacity="0.4"/>
    <rect x="75"  y="60" width="18" height="70" rx="3" fill="var(--c-brand)" opacity="0.7"/>
    <rect x="100" y="40" width="18" height="90" rx="3" fill="#10B981" opacity="0.8"/>
    <rect x="125" y="70" width="18" height="60" rx="3" fill="var(--c-brand)" opacity="0.5"/>
...
const target = (
  <svg viewBox="0 0 200 160" className="w-full h-auto max-w-[220px] mx-auto">
    <circle cx="100" cy="80" r="55" fill="none" stroke="var(--c-brand)" strokeOpacity="0.2" strokeWidth="2"/>
    <circle cx="100" cy="80" r="35" fill="none" stroke="var(--c-brand)" strokeOpacity="0.4" strokeWidth="2"/>
    <circle cx="100" cy="80" r="15" fill="var(--c-brand)" opacity="0.7"/>
    <circle cx="100" cy="80" r="4"  fill="var(--c-surface)"/>
  </svg>
)
