      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
              ...
              <Card>
                <CardContent className="pt-5">
                  ...
                  <form onSubmit={handleCreate} noValidate className="space-y-3">
                    ...
                    <div>
                      ...
                      <div
                        ...
                        className={`w-full rounded-lg border-2 border-dashed px-4 py-5 text-center cursor-pointer transition-all duration-150 ${
                          file
                            ? 'border-[#E9C92F]/50 bg-[#E9C92F]/5'
                            : 'border-border hover:border-[#E9C92F]/30 hover:bg-elevated'
                        }`}
                      >
                        {file ? (
                          <div className="flex items-center justify-center gap-2">
                            <Upload size={14} className="text-[#E9C92F] flex-shrink-0" />
                            <span className="text-sm text-[#E9C92F] font-medium truncate max-w-xs">{file.name}</span>
                    ...
                    {loading && loadingMsg && (
                      <div className="flex items-center gap-2 text-[#E9C92F] text-sm">
        ...
        {stats.length === 0 && !showForm ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-20">
            ...
            <button onClick={() => setShowForm(true)} className="text-[#E9C92F] text-sm font-semibold hover:text-[#F2D53C] transition-colors cursor-pointer">
