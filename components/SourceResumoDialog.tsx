      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            className="h-10 w-full rounded-lg border border-border bg-elevated px-3 text-sm text-foreground outline-none focus:border-[#E9C92F]/40 cursor-pointer"
          >
        ...
        <div>
          ...
          {type === 'text' ? (
            <textarea
              ...
              rows={6}
              className="w-full resize-y rounded-lg border border-border bg-elevated px-3 py-2 text-sm text-foreground outline-none placeholder:text-muted-foreground focus:border-[#E9C92F]/40"
            />
          ) : (
